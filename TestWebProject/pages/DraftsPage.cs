...
namespace TestWebProject.forms
{
	public class DraftsPage : BasePage
	{
		...
		public DraftsPage() : base(_draftTable)
		{
            ...
            SerilogLogger.Logger.Information("Open Drafts Page");
		}

		[FindsBy(How = How.XPath, Using = ".//*[@role='main']//tr[@jsmodel]")]
		private IList<IWebElement> DraftNotes;

		Checkbox SelectAllCheckbox = new Checkbox(By.XPath(".//*[@gh='mtb']//*[@role = 'presentation']"), "Select All Checkbox");

		Button DiscardDraftsButton = new Button(By.XPath(".//*[@gh='mtb']//div[@act='16']"), "Discard Drafts Button");
		...
		{			
            ...
            SerilogLogger.Logger.Information("Getting Number Of Drafts");
			return this;
		}
